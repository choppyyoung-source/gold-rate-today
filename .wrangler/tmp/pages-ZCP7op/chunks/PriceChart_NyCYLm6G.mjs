...
import { n as reactExports } from "./worker-entry_npiV1CLA.mjs";
function round(v) {
  return v + 0.5 | 0;
}
...
function PriceChart({
      ...
      options: {
        ...
        plugins: {
          tooltip: {
            ...
            callbacks: {
              label: (ctx2) => {
                const val = ctx2.parsed.y ?? 0;
                return currency === "INR" ? `₹${val.toLocaleString("en-IN")}` : `$${val.toLocaleString("en-US", { minimumFractionDigits: 2 })}`;
              }
            }
          }
        },
        scales: {
          ...
          y: {
            ...
            ticks: {
              font: { size: 11 },
              callback: (val) => currency === "INR" ? `₹${Number(val).toLocaleString("en-IN")}` : `$${Number(val).toLocaleString()}`
            }
          }
        }
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl sm:text-2xl font-bold text-gray-900", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: ["7d", "30d"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setPeriod(p),
          className: `px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${period === p ? "bg-amber-700 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`,
          children: p === "7d" ? "7 Days" : "30 Days"
        },
        p
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-xl p-4", style: { height: "320px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef }) })
  ] });
}
export {
  PriceChart as P
